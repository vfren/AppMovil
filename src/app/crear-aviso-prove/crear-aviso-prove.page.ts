...
@Component({
  selector: 'app-crear-aviso-prove',
  templateUrl: './crear-aviso-prove.page.html',
  styleUrls: ['./crear-aviso-prove.page.scss'],
})
export class CrearAvisoProvePage  {
  ...
  constructor() {
    ...
    this.pretension_renta_proveedor= 0;
    this.region = '';
    this.comuna = '';
  }
  guardarAviso() {
  ...
  formatSalary(event: any) {
    ...
    this.pretension_renta_proveedor = salaryValue;
  }
}
